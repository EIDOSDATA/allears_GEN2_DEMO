...
#ifndef INC_APP_ECHO_FLASH_MEMORY_H_
#define INC_APP_ECHO_FLASH_MEMORY_H_
...
HAL_StatusTypeDef Echo_Flash_Write(void);
HAL_StatusTypeDef Echo_Flash_Read(void);
...
#endif /* INC_APP_ECHO_FLASH_MEMORY_H_ */
