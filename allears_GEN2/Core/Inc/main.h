...
#define BIPHASIC_SW_Pin GPIO_PIN_9
#define BIPHASIC_SW_GPIO_Port GPIOA
#define PEAK_DISCHG_SW_Pin GPIO_PIN_10
#define PEAK_DISCHG_SW_GPIO_Port GPIOA
#define CATHODE_DISCHARGE_Pin GPIO_PIN_11
#define CATHODE_DISCHARGE_GPIO_Port GPIOA
#define ANODE_DISCHARGE_Pin GPIO_PIN_12
#define ANODE_DISCHARGE_GPIO_Port GPIOA
