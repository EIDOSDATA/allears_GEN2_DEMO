...
static void MX_GPIO_Init(void)
{
	...
	HAL_GPIO_WritePin(GPIOA,
			TP0_Pin | TP1_Pin | BIPHASIC_SW_Pin | PEAK_DISCHG_SW_Pin
	...
	/*Configure GPIO pins : TP0_Pin TP1_Pin BIPHASIC_SW_Pin PEAK_DISCHG_SW_Pin
	 CATHODE_DISCHARGE_Pin ANODE_DISCHARGE_Pin */
	GPIO_InitStruct.Pin = TP0_Pin | TP1_Pin | BIPHASIC_SW_Pin
			| PEAK_DISCHG_SW_Pin | CATHODE_DISCHARGE_Pin | ANODE_DISCHARGE_Pin;
