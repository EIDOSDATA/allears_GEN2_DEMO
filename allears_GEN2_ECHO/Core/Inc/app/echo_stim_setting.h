...
#define PULSE_HZ_FREQ						ex_pwm_param.pulse_freq
#define PULSE_WIDTH_TIME					ex_pwm_param.pulse_width
#define PULSE_DEAD_TIME						ex_pwm_param.dead_time
...
#define PULSE_FREQ_ARR						ECHO_MASTER_ARR / PULSE_HZ_FREQ
#define TOTAL_PULSE_WIDTH_TIME				(2*GLICH_DEBOUNCING_TIME) + (2*PULSE_WIDTH_TIME) + PULSE_DEAD_TIME

#define VOLTAGE_RELATED_PULSE_WIDTH			ex_voltage_r_pw
#define VOLTAGE_VALUE_OUTPUT				ex_voltage_val_output
#define SLOPE_CONTROL_END_FLAG				ex_slope_ctrl_end_f
