...
#ifndef INC_APP_TD_FLASH_MEMORY_H_
#define INC_APP_TD_FLASH_MEMORY_H_
...
HAL_StatusTypeDef td_Flash_Write(void);
HAL_StatusTypeDef td_Flash_Read(void);
...
#endif /* INC_APP_TD_FLASH_MEMORY_H_ */
