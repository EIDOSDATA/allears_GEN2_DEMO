...
/* STEPUP PULSE TIMER : TIM1 */
#define TD_STEPUP_PULSE_PSC					(int)(TD_MASTER_STIM_PSC / TD_TIMER_SCALE)
#define TD_STEPUP_PULSE_ARR					(int)(((TD_MASTER_CLK_FREQ / TD_STIM_PSC) / TD_PULSE_HZ_FREQ))

/* STIM TIMER : TIM2 */
#define TD_STIM_PSC							(int)(TD_MASTER_STIM_PSC / TD_TIMER_SCALE)
#define TD_STIM_ARR							(int)(((TD_MASTER_CLK_FREQ / TD_STIM_PSC) / TD_PULSE_HZ_FREQ))

/* STEPUP DATA FEEB-BACK TIMER : TIM16 */
#define TD_STEPUP_FDBK_PSC					(int)(TD_MASTER_STEPUP_PSC / TD_TIMER_SCALE)
#define TD_STEPUP_FDBK_ARR					(int)(((TD_MASTER_CLK_FREQ / TD_STEPUP_FDBK_PSC) / TD_STEPUP_HZ_FREQ))
...
#define TD_CURRENT_CTRL_TIME0				(int)(TD_PULSE_WIDTH_TIME + TD_GLICH_DEBOUNCING_TIME)
#define TD_CURRENT_CTRL_TIME1				(int)(TD_PULSE_WIDTH_TIME + TD_PULSE_DEAD_TIME + TD_GLICH_DEBOUNCING_TIME)
#define TD_CURRENT_CTRL_TIME2				(int)((TD_PULSE_WIDTH_TIME * 2) + TD_PULSE_DEAD_TIME + TD_GLICH_DEBOUNCING_TIME) // 2PW + D + S
#define TD_CURRENT_CTRL_TIME3				(int)TD_GLICH_DEBOUNCING_TIME

/* ANODE CONTROL PULSE */
#define TD_ANODE_PULSE_TIME					(int)(TD_PULSE_WIDTH_TIME + (TD_GLICH_DEBOUNCING_TIME * 2))

/* CATHODE CONTROL PULSE */
#define TD_CATHODE_PULSE_TIME0				(int)((TD_PULSE_WIDTH_TIME * 2) + TD_PULSE_DEAD_TIME + (TD_GLICH_DEBOUNCING_TIME * 2))
#define TD_CATHODE_PULSE_TIME1				(int)(TD_PULSE_WIDTH_TIME + TD_PULSE_DEAD_TIME)

/* ADC CONTROL TIMER VALUE */
#define TD_TOTAL_PULSE_WIDTH_TIME			(int)((2*TD_GLICH_DEBOUNCING_TIME) + (2*TD_PULSE_WIDTH_TIME) + TD_PULSE_DEAD_TIME)
#define TD_TIM2_ADC2_TRG_TIME				TD_CURRENT_CTRL_TIME0

#define TD_CURRENT_DAC_ALL_OFF				HAL_GPIO_WritePin(GPIOA, 0x1E00, GPIO_PIN_SET)
#define TD_CURRENT_DAC_ALL_ON				HAL_GPIO_WritePin(GPIOA, 0x1E00, GPIO_PIN_RESET)
#define TD_CURRENT_DAC_CONTROL				HAL_GPIO_WritePin(GPIOA, TD_CURRENT_STRENGTH_STEP << 9, GPIO_PIN_RESET)
...
#define TD_VOLTAGE_TABLE_MAX				31
#define TD_VOLTAGE_TABLE_MAX_VALUE			31

#define TD_NOLOAD_TABLE_MAX					11
#define TD_NOLOAD_TABLE_MAX_VALUE			11
