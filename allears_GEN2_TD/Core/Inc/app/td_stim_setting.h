...
#define TD_TIMER_SCALE						(int)(80000000 / TD_CLK_FREQ)
#define TD_MASTER_CLK_FREQ					HAL_RCC_GetHCLKFreq() // NOW CLK
#define TD_CLK_FREQ							HAL_RCC_GetHCLKFreq() // NOW CLK
...
#define TD_PULSE_FREQ_ARR					(TD_CLK_FREQ / TD_MASTER_PSC) / TD_PULSE_HZ_FREQ
