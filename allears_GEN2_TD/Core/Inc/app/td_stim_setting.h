...
#define TD_GLICH_DEBOUNCING_TIME			50 /* 50us */
...
/* TEST */
#define AUL_TIM2_PERIOD_LEN								10000
#define AUL_TIM2_PULSE_LEN								1000
#define AUL_TIM2_DELAY_LEN								200 // DEADTIME
#define AUL_TIM2_STABLE_LEN								50 // GLICH_DEBOUNCING_TIME
#define AUL_TIM2_CH1_DMA_DATA_TOTAL_NUM					4
#define AUL_TIM2_CH4_DMA_DATA_TOTAL_NUM					2
#define AUL_TIM2_ADC2_TRG_TIME							gAulTim2Ch1Dma_buf[0] + 100
/* TEST */
