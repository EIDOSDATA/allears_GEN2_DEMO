...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PB0     ------> ADC2_IN15
    */
    GPIO_InitStruct.Pin = PEAK_DETECTION_L_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG_ADC_CONTROL;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(PEAK_DETECTION_L_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = PEAK_DETECTION_R_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG_ADC_CONTROL;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(PEAK_DETECTION_R_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA6     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(VDDH_FEEDBACK_GPIO_Port, VDDH_FEEDBACK_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB0     ------> ADC2_IN15
    */
    HAL_GPIO_DeInit(PEAK_DETECTION_L_GPIO_Port, PEAK_DETECTION_L_Pin);

    HAL_GPIO_DeInit(PEAK_DETECTION_R_GPIO_Port, PEAK_DETECTION_R_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA5     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = STIM_CATHODE_Pin|STIM_CURRENT_CTRL_Pin|STIM_ANODE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, QCC_UART_TX_Pin|QCC_UART_RX_Pin);
