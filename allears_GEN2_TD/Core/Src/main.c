...
static void MX_GPIO_Init(void)
{
	...
	HAL_GPIO_WritePin(GPIOA,
			GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_3 | GPIO_PIN_5 | GPIO_PIN_6
					| GPIO_PIN_7 | GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_10
					| GPIO_PIN_11 | GPIO_PIN_12, GPIO_PIN_RESET);

	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOB,
	GPIO_PIN_0 | QCC_CRTL0_Pin | LED_Pin | GPIO_PIN_4 | GPIO_PIN_5,
			GPIO_PIN_RESET);
	...
	/*Configure GPIO pins : PB0 QCC_CRTL0_Pin LED_Pin PB4
	 PB5 */
	GPIO_InitStruct.Pin = GPIO_PIN_0 | QCC_CRTL0_Pin | LED_Pin | GPIO_PIN_4
			| GPIO_PIN_5;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
