...
int ref_voltage_table_20mhz[TD_VOLTAGE_PW_MAX_VALUE] =
{ 507500, 908200, 1303000, 1625000, 1973000, 2343000, 2669000, 2973000, 3268000,
		3552000, 3815000, 4055000, 4263000, 4430000, 4498000, 4503000 }; // 16

int ref_adc_value_table_20mhz[TD_VOLTAGE_PW_MAX_VALUE] =
{ 272, 375, 475, 579, 675, 769, 849, 932, 1015, 1097, 1166, 1232, 1288, 1322,
		1347, 1352 }; // 16

/* Voltage Scale : 10 uV >> ADC BUFFER IS 10 */
int ref_adc_voltage_table_20mhz[TD_VOLTAGE_PW_MAX_VALUE] =
{ 13010, 23600, 33350, 44990, 54350, 73290, 84480, 93970, 101300, 111000,
		117000, 122100, 127200, 127200, 127500 }; // 16
...
uint32_t td_ADC_Calc_Stepup_V(uint32_t in_adc_val, uint32_t r1, uint32_t r2)
{
	...
	/*
	 // TEST
	 if (TD_VOLTAGE_RELATED_PULSE_WIDTH >= TD_VOLTAGE_PW_MAX_VALUE - 2)
	 {
	 TD_VOLTAGE_RELATED_PULSE_WIDTH = TD_VOLTAGE_PW_MAX_VALUE - 2;
	 }
	 */
